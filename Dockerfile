...
# Aufruf:   docker build --tag niklastremmel/mitarbeiter:2026.10.19-hardened .
#               ggf. --no-cache
#
...
#
#           docker debug niklastremmel/mitarbeiter:2026.10.19-hardened
#           docker scout sbom niklastremmel/mitarbeiter:2026.10.19-hardened
#           docker scout cves niklastremmel/mitarbeiter:2026.10.19-hardened
#           docker save niklastremmel/mitarbeiter:2026.10.19-hardened > mitarbeiter.tar
...
LABEL org.opencontainers.image.title="mitarbeiter" \
    org.opencontainers.image.description="Appserver mitarbeiter mit Basis-Image Trixie hardened" \
    org.opencontainers.image.version="2026.10.19-hardened" \
...
ENTRYPOINT ["python", "-m", "mitarbeiter"]
