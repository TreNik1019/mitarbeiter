...
from mitarbeiter.config.config import app_config, resources_path
...
_dbname: Final[str] = _db_toml.get("name", "mitarbeiter")
_host: Final[str] = _db_toml.get("host", "postgres")
_username: Final[str] = _db_toml.get("username", "mitarbeiter")
