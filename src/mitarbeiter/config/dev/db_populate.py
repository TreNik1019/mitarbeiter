...
from mitarbeiter.config.config import resources_path
...
from mitarbeiter.config.dev_modus import dev_db_populate
from mitarbeiter.repository import engine
...
class DbPopulateService:
    ...
    def _load_csv_files(self) -> None:
        ...
        with self.engine_admin.connect() as connection:
            connection.execute(text("SET search_path TO mitarbeiter;"))
